...
function ProductsContent() {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        setLoading(true);
        // Cargamos ambas fuentes en paralelo — si accesorios falla, no rompemos el catálogo
...
export default function ProductsPage() {
  return (
    <Suspense fallback={<div className="p-20 text-center font-bold">Cargando catálogo...</div>}>
      <ProductsContent />
    </Suspense>
  );
}
