        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              placeholder="ej: 87"
              disabled={!esUsado}
              className="w-full px-3 py-2 text-sm border border-gray-200 rounded-full focus:border-color-principal outline-none disabled:bg-gray-50 disabled:text-gray-300 transition-colors"
            />
          </div>
        </div>
