...
function VarianteCard({
  ...
  const imagenesStock: string[] = useWatch({ control, name: `variantes.${index}.imagenesStock` }) ?? [];
  const imagenesReales: string[] = useWatch({ control, name: `variantes.${index}.imagenesReales` }) ?? [];
